...
\begin{document}
	...
	\title{Instructions to authors for the preparation of \\CONVR/ICIO manuscripts}
	...
	\begin{abstract}
		...
		This document sets out the requirements for preparing manuscripts for the CONVR/ICIO.
	...
	\begin{keywords}
		Instructions; Formatting; Authors; CONVR/ICIO
	\end{keywords}
	...
	The recommended length for Scientific Papers is 6 to 8 pages (4 pages for Short Papers), including text, figures, tables, and references. For more information about the paper types, refer to the “Paper and Presentation Types” on the CONVR/ICIO website. Electronic files should not exceed 5 megabytes.
	...
	The manuscript shall be prepared using either the MS Word (.docx) template or \hologo{LaTeX} using the Overleaf template available on the CONVR/ICIO website. You can alternatively download the source code from the Overleaf template and use it in another editor of your choice.
	...
	Do not add anything in the footers or headers, even page numbers. These will be added by the CONVR/ICIO Technical Committee when compiling the Proceedings.
	...
	References to the literature should be cited in the main text with an Arabic number in square brackets \cite{Ha}. 
	References should then appear in cited order at the very end of your paper in the Section \textbf{References}. 
	Start each reference on a new line with its number in square brackets \cite{Ha}. 
	Citation formats are given below for: a journal article \cite{Ha}, conference paper \cite{Kwok}, book \cite{Book}, and a website \cite{Website}.

	The formatting of the references is done automatically by the \hologo{LaTeX} template.
	All you need to do is add your references in the CONVRICIO.bib Bibtex file and cite the papers in the text using the command \verb|\cite{}| (as well as \verb|\citet{}|).
